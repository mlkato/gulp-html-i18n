        ...
        return function(langResource) {
          ...
          if (file._lang_) {
            ...
            langResource.LANG_LIST.forEach(function(lang) {
              var newFile, newFilePath, originPath, tFileName, trace, tracePath;
              ...
              if (opt.specifyKey != null) {
                ...
                if (opt.replaceWithKey) {
                  ...
                  newFilePath = gutil.replaceExtension(newFilePath, seperator + langResource[lang][tFileName][opt.specifyKey] + '.html');
                }
